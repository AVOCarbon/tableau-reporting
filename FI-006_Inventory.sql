...
--recupère 3 champs de la vue Axis_Reference dans la sous requête axis_reference		
		axis_reference AS (
         SELECT "Axis_Reference"."Sc_inventory_type",
		  ...
		  --condition : recupère uniquement les enregistrements ou le Site de la Axis_Reference est égal à celle de la première sous requête inventory
		  --ainsi que la Reference_internal de la Axis_Reference est égal à la Internal_reference de la première sous requête inventory
